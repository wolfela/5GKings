...
public class SwitchConfigurator {
    ...
    private Flow createFlow(String edge_nodeconnector) {
        ...
        //TCP Match
        PortNumber srcTcp = new PortNumber(40);
        PortNumber dstTcp = new PortNumber(42);
        Match tcpMatch = new MatchBuilder()

            .setLayer4Match(new TcpMatchBuilder()
                .setTcpSourcePort(srcTcp)
                .setTcpDestinationPort(dstTcp)
                .build())
            .build();
        ...
        Action queueAction = actionBuilder
                .setOrder(0).setAction(new SetQueueActionCaseBuilder()
                    ...
                    .setQueueId((long)3) //setting queue id to 3
                    .build())
                .build())
                .build();
        ...
        Instruction meter = new InstructionBuilder()
                .setOrder(1).setInstruction(new MeterCaseBuilder()
                        .setMeter(new MeterBuilder()
                                .setMeterId(new MeterId((long) 1))
                                .build())
                        .build())
                .build();

        Instructions applyInstructions =  new InstructionsBuilder()
                .setInstruction(ImmutableList.of(applyActionsInstruction, meter))
                .build();
